...
class FileWindow(QDialog):
    ...
    def openFile(self, stringa: str):
        try:
            ...
            #                      "all raw files should end with raw.fif, raw_sss.fif, raw_tsss.fif, _meg.fif, \n _eeg.fif, _ieeg.fif, raw.fif.gz, raw_sss.fif.gz,\n raw_tsss.fif.gz, _meg.fif.gz, _eeg.fif.gz or _ieeg.fif.gz")
